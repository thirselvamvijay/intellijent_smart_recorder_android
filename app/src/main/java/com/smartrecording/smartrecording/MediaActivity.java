...
import com.smartrecording.smartrecording.service.StartRecordServiceLibrary;
import com.smartrecording.smartrecording.service.StopRecordService;
import com.smartrecording.smartrecording.service.StopRecordServiceLibrary;
...
public class MediaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MediaActivity.this, "Auto Recording Start", Toast.LENGTH_SHORT).show();
                startRecord();
        ...
        btn_stop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MediaActivity.this, "Auto Recording Stop", Toast.LENGTH_SHORT).show();
                stopRecord(pathSave);
                timer.cancel();
                timer.purge();
                StopRecordServiceLibrary tsk = new StopRecordServiceLibrary(MediaActivity.this);
                tsk.execute();
            }
        });
    ...
    private void stopRecord(String pathSave){
        mediaRecorder.stop();
        StartRecordServiceLibrary tsk = new StartRecordServiceLibrary(MediaActivity.this, pathSave);
        tsk.execute();
    }
